...
export default function NewPlacementScreen() {
    ...
    */
    ...
    const isValidInput = isValidRollNo && isValidCtc && isValidJobRole && isValidCompanyId && isValidJobLocation && isValidPlacementDate && isValidIntern && isValidPPO && isValidOnCampus && isValidGirlsDrive;
