...
export default function NewPlacementScreen() {
    ...
    */
    ...
    useEffect(() => {
        ...
        //console.log("studentId",studentId,student.studentId);
        //console.log("studentRollNo",studentRollNo,student.studentRollNo);
                ...
                <header className="absolute inset-x-0 top-0 z-50">
                    <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                        ...
                        <div className="flex lg:flex lg:flex-1 lg:justify-end">
                            <Link href={`/dashboard/admin/student/${studentId}`} className="bg-[#000000] text-[#ffffff] rounded-xl p-2 items-center align-middle flex flex-row hover:bg-[#3b3b3b] ">
